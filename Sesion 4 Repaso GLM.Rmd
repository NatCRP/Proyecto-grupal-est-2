...
#Se aplica a unidades discretas, modelos orientados a una variable dependiente y de conteo, unidades de tiempo o espacio. 
...
```{r}
library(rio)
data1=import("https://github.com/gabrielramost/Lab_estadistica_2/blob/main/Sesi%C3%B3n%204/IOP_1119_01_02_D.sav?raw=true")
...
Interpretación: 
#Como el dato es mayor a uno, aumenta. Exponenciales. 
...
dotwhisker::dwplot(list(Poisson1=modelo1,Poisson2=modelo2),exp=T)  +
  ...
  geom_vline(xintercept = 1,
           ...
           linetype = 2)
```
# mientras este lejos del uno, explica mejor la variable dependiente. 
